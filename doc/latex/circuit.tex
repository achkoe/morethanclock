...
\begin{tikzpicture}[scale=0.3, circuit ee IEC]]
    ...
    \draw(0, 7)  node[rotate=90]{ATMEGA328};
    \end{scope}
    ...
    % --- PROG CONNECTOR ---
    \begin{scope}[yshift=0.5cm, xshift=5cm]
    ...
    \node (R1) [resistor,point up,info={\tiny $R_1$}] at (15,10) {};
    \node (R2) [resistor,point up,info'={\tiny $R_2$}] at (17,10) {};
    \node (D)  [diode, point down, scale=2] at (17,7) {};
    \draw[->] (17.5,7.5) -- +(0.5,0.5);
    \draw[->] (17.5,7.0) -- +(0.5,0.5);
    \node (CO1) [contact] at (15,14) {};
    \node (GND1) [ground, point down] at (17,3) {};
    \node (VDD1) [vdd, info={\tiny $V_{DD}$}] at (17,12) {};

    %--- Transistor ---
    \node at (16, 5) [draw, scale=0.01] (Q_B) {};
    \node at (17, 6) [draw, scale=0.01] (Q_C) {};
    \node at (17, 4) [draw, scale=0.01] (Q_E) {};
    \draw (Q_B) -- (Q_C);
    \draw[->] (Q_B) -- (Q_E);
    \draw[thick] (16, 4.5) -- (16, 5.5);
    ...
    \draw[wire] (ATMEGA23) -- +( 9.0, 0) -- +( 9.0, 21) -- (LED_DIN);
    \draw[wire] (ATMEGA24) -- +( 9.5, 0) -- +( 9.5, 19) -- (LED_CS);
    \draw[wire] (ATMEGA25) -- +(10.0, 0) -- +(10.0, 17) -- (LED_CLK);

    % --- wires from ATMEGA to PROG Connector
    \draw[wire] (ATMEGA19) -- +(5.5, 0) -- +(5.5, -3.5) -- (PROG_3);
    \draw[wire] (ATMEGA18) -- +(4.5, 0) -- +(4.5, -2.5) -- (PROG_1);
    \draw[wire] (ATMEGA17) -- +(5, 0) -- (PROG_4);
    \draw[wire] (ATMEGA1) -- +(-1, 0) -- +(-1, 1.5) -- +(10.5, 1.5) -- +(10.5, -12) -- (PROG_5);

    % --- wires from ATMEGA to DCF77
    \draw[wire] (ATMEGA28) -- +(13, 0) -- (DCF_Q);
    ...
    \node (GND12) [ground, point down] at (-7, 15) {};
    \draw[wire] (LCD3_VO) -| (GND12);
    ...
    % --- different VDD ---
    \node (VDD2) [vdd, info=left:{\tiny $V_{DD}$}] at (-9, 15 - 7) {};
    \draw[wire] (ATMEGA7) -- (VDD2);

    \node (VDD3) [vdd, point down, info={\tiny $V_{DD}$}] at (-8, 14) {};
    \draw[wire] (LCD1_VDD) -- (VDD3);

    \node (VDD4) [vdd, point down, info={\tiny $V_{DD}$}] at (11, 5+27) {};
    \draw[wire] (LED_VCC) -- (VDD4);

    \node (VDD5) [vdd, point down, info={\tiny $V_{DD}$}] at (1+14,0.5+23) {};
